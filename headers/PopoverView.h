...
@class CAShapeLayer, NSArray, NSString, UIColor, UITableView, UITapGestureRecognizer, UIWindow;

@interface PopoverView : UIView <UITableViewDelegate, UITableViewDataSource>
{
