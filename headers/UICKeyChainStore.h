...
@interface UICKeyChainStore : NSObject
{
    ...
    unsigned long long _authenticationPolicy;
...
@property(readonly, nonatomic) unsigned long long authenticationPolicy; // @synthesize authenticationPolicy=_authenticationPolicy;
...
- (void)setAccessibility:(long long)arg1 authenticationPolicy:(unsigned long long)arg2;
- (_Bool)setData:(id)arg1 forKey:(id)arg2;
- (_Bool)setData:(id)arg1 forKey:(id)arg2 error:(id *)arg3;
- (_Bool)setData:(id)arg1 forKey:(id)arg2 genericAttribute:(id)arg3;
- (_Bool)setData:(id)arg1 forKey:(id)arg2 genericAttribute:(id)arg3 error:(id *)arg4;
...
@property(nonatomic) _Bool useAuthenticationUI; // @synthesize useAuthenticationUI=_useAuthenticationUI;
