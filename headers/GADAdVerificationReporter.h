...
@class GADOMIDAdSession, GADObserverCollection, GADWebViewController, NSMutableArray, NSString, UIView;
...
- (void)endAdSession;
- (id)initWithWebViewController:(id)arg1 mediaType:(long long)arg2 friendlyObstructionView:(id)arg3 contentURL:(id)arg4 impressionType:(unsigned long long)arg5 adType:(id)arg6;
