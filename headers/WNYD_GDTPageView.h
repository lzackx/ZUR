...
@protocol WNYD_GDTPageViewDelegate;

@interface WNYD_GDTPageView : UIView <GDTNativeExpressAdDelegete, WNYD_GDTPageViewDelegate>
{
    GDTNativeExpressAdView *_nativeExpressAdView;
    GDTNativeExpressAd *_nativeExpressAd;
    WNYD_AdvertConfigModel *_ADModel;
    id <WNYD_GDTPageViewDelegate> _mydelegate;
...
@property(nonatomic) __weak id <WNYD_GDTPageViewDelegate> mydelegate; // @synthesize mydelegate=_mydelegate;
