...
- (void)beginAdSession;
- (void)dealloc;
- (id)initWithAd:(id)arg1 webViewController:(id)arg2 mediaType:(long long)arg3 partnerName:(id)arg4 contentURL:(id)arg5 impressionType:(unsigned long long)arg6 adType:(id)arg7;
