...
@class NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout, UIImageView, UIScrollView, UIView, WNYD_AdvertConfigModel, WNYD_BookCategories, WNYD_ErrorStatusView, WNYD_NetworkManager;

@interface WNYD_TypeContentDetailController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, WNYD_AdvertContentViewDelegate, WNYD_ErrorStatusViewDelegate>
{
    _Bool _TopADLoad;
    _Bool _MiddleADLoad;
    _Bool _BottomADLoad;
