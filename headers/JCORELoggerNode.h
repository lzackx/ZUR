...
@protocol JCORELogger, OS_dispatch_queue;

@interface JCORELoggerNode : NSObject
{
    id <JCORELogger> _logger;
...
@property(readonly, nonatomic) id <JCORELogger> logger; // @synthesize logger=_logger;
